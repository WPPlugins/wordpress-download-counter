...
class WordPress_Download_Counter {
	...
	//<![CDATA[
		jQuery(document).ready(function($){
			if ( jQuery(".wpdlcounter").length > 0 ) {
				...
				var wpdlcounter = setInterval(function() {
					...
					if ( wpdlcounter_refreshes > 20 )
						return;
					jQuery.get("<?php echo esc_js( add_query_arg( 'wpdlcounter', 1, trailingslashit( get_bloginfo('url') ) ) ); ?>&nocache=" + Math.random(), function(count) {
						if ( count )
							jQuery(".wpdlcounter").fadeOut("fast", function() {
